...
public class HellephantEnemy : EntityMovement
{
    ...
    public void AnimMeleeAttack()
    {
        ...
        if (victim != null && Vector3.Distance(_target.position, transform.position) <= meleeDistance * 6)
        {
    ...
    private void OnHellephantDeath()
    {
        _isDeath = true;
    }
